...
abstract class _CircleTableStore extends TableStore<EntityHistoryCircle>
  ...
  void showAddRecordDialog(BuildContext context, int index, List<EntityHistoryCircle> sortedList) {
      ...
      builder: (dialogContext) {
        return StatefulBuilder(builder: (builderContext, setState) {
          ...
          final data = MeasurementDetails(
            ...
            viewNormsLabel: 'Смотреть нормы окружности головы',
            onViewNormsTap: () {
            ...
            onNoteDelete: () async {
              ...
              try {
                await restClient.growth.deleteGrowthCircleDeleteNotes(
                    dto: GrowthDeleteCircleDto(id: currentEntity.id));
