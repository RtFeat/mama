...
class VaccinesViewStore extends _VaccinesViewStore with _$VaccinesViewStore {
  VaccinesViewStore({
...
abstract class _VaccinesViewStore with Store {
  ...
  void updateData() {
    if (isVaccinationValid && vaccination.value != model.vaccination) {
      model.setVaccination(vaccination.value!);
    }
