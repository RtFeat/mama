...
class WeekTableWidget extends StatelessWidget {
  ...
  const WeekTableWidget({super.key, required this.startOfWeek});
  ...
  Widget build(BuildContext context) {
    ...
    return Observer(builder: (_) {
      ...
      for (final entity in sleepTableStore.listData) {
        ...
        while (dayCursor.isBefore(intervalEnd)) {
          ...
          if (dayEnd.isAfter(dayStart)) {
            // Разбиваем внутри дня по часовым "кубикам"
      ...
      return CalendarControllerProvider(
          ...
          child: SizedBox(
            ...
            child: WeekView(
            key: ValueKey('sleep_week_${base.toIso8601String()}'),
            ...
            keepScrollOffset: true,
                ...
                // Принудительные метки 00:00 сверху и снизу
                Positioned(
                  top: 34, // weekTitleHeight
                  left: 8,
                  child: IgnorePointer(
